...
if(currURL.indexOf("/sales_order/view/order_id/") >= 0 && document.title.indexOf("Orders / Sales / Magento Admin") >= 0){
	...
	if(contactText !== null){
		...
		var buttonText = document.createTextNode("Verify with Whitepages Pro");
		button.id = "wpp_idcheck_button";
		button.title = "Verify with Whitepages Pro";
		button.className = "scalable";
		button.type = "button";
		button.onclick = function(){ window.open(WPPURL,'_blank');};
