// ==UserScript==
// @name         Magento - Whitepages Identity Check Integration
// @namespace    http://pro.whitepages.com
// @version      1.0
// @description  Embeds a button within Magento order details pages to verify contact information integration with Whitepages Pro Identity Check 
// @author       Trevor Anderson <tanderson@whitepages.com>
// @match        */index.php/*/sales_order/view/order_id/*
// @grant        none
// ==/UserScript==

//First thing we need to do is wait until required elements are loaded.
...
if(contactText !== null){
	...
	WPPURL += 'utm_source=userscript&utm_medium=extension&utm_campaign=magento'
